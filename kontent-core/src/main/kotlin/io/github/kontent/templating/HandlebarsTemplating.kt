...
class HandlebarsTemplating(themePath: ThemePath, assets: Assets) {
    ...
    fun renderPage(targetUri: Uri, markdown: Markdown, navigation: Navigation): Page {
